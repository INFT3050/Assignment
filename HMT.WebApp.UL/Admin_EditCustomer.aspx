...
<asp:Content ID="Content2" ContentPlaceHolderID="contentplaceholder1" runat="server">
    ...
    <div style="margin-left:20px; margin-top:20px">
        <!-- Update and delete section for editing customer records -->
            ...
            <asp:Label ID="msgLbl" runat="server" BorderStyle="None"></asp:Label>
        
    </div>
    <br />
    <div id="hide" runat="server" style="margin-left:20px;">  <!-- Hidden div for editing customers when id entered. -->
        <asp:TextBox ID="first" runat="server" TabIndex="1"></asp:TextBox>
        <asp:TextBox ID="last" runat="server" TabIndex="2"></asp:TextBox>
        <asp:TextBox ID="email" runat="server" TabIndex="3"></asp:TextBox>
        <asp:TextBox ID="address" runat="server" TabIndex="4"></asp:TextBox>
        <asp:TextBox ID="suspended" runat="server" TabIndex="5" ReadOnly="true"></asp:TextBox>
