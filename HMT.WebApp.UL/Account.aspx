    ...
    <div class="grid">
        <div class="centered listed">
            ...
            <div class="grouping" style="border-top:1px solid darkgrey;">
                ...
                <asp:TextBox id="firstName" runat="server" CssClass="inputTxt alignVert"></asp:TextBox>
                <img class="edit" src="Images/edit.png"/>
            </div>
            <div class="grouping">
                <span class="textLbl">Last Name</span>
                <asp:TextBox id="lName" runat="server" CssClass="inputTxt alignVert"></asp:TextBox>
                <img class="edit" src="Images/edit.png"/>
            </div>
            <div class="grouping">
                <span class="textLbl">Email</span>
                <asp:TextBox id="eMail" runat="server" CssClass="inputTxt alignVert"></asp:TextBox>
                <img class="edit" src="Images/edit.png"/>
            </div>
            <div class="grouping">
                <span class="textLbl">Address</span>
                <asp:TextBox id="address" runat="server" CssClass="inputTxt alignVert"></asp:TextBox>
                <img class="edit" src="Images/edit.png"/>
            </div>
            <div class="grouping">
                <span class="textLbl">Password</span>
                <asp:TextBox id="password" runat="server" CssClass="inputTxt alignVert"></asp:TextBox>
                <img class="edit" src="Images/edit.png"/>
            </div>

            <asp:Button ID="updateChanges" title="Update Changes" runat="server" text="Update Changes" TabIndex="3" OnClick="updateChanges_Click"/>
